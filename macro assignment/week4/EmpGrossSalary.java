...
class Account2 extends Employee {
    private double deptsal;
 
    public Account2(int id, String name, double baseSalary,double HRA,double DA, double deptsal) {
...
public class EmpGrossSalary {
    public static void main(String[] args) {
        Account2 acc1 = new Account2(2, "Jane Smith", 60000, 10,73,2500);
